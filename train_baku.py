...
class WorkspaceIL:
    def __init__(self, cfg):
        ...
        # load data
        dataset_iterable = hydra.utils.call(self.cfg.agent.bc_dataset)
        ...
        self.cfg.suite.task_make_fn.act_max = self.stats['raw_max'].tolist()
        self.cfg.suite.task_make_fn.act_min = self.stats['raw_min'].tolist()
